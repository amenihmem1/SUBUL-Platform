...
export function InterviewFeedPanel({
  ...
  const textDisabled = interviewEnded || !cvUploaded || inputMode === "voice" || sending;
    ...
    <aside className="chat-panel">
      ...
      <div className="chat-header">
        ...
        <span className="message-count">
          ...
          {feed.length} {feed.length > 1 ? copy.messageCountPlural : copy.messageCountSingular}
        </span>
      </div>
          ...
          {feed.length === 0 ? (
            ...
            feed.map((item) => (
              <div
                ...
                onContextMenu={item.role === "interviewer" ? (event) => event.preventDefault() : undefined}
              >
