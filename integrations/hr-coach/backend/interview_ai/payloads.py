...
SKILL_KEYS = {"communication", "teamwork", "problem_solving", "motivation"}
VALID_PHASES = {"INTRO", "BEHAVIOR", "SOFT", "MOTIVATION", "FINAL"}

MAX_EVIDENCE_CHARS = 80       # évidence ultra-courte (1–4 mots idéalement)
MAX_NOTES = 2                 # max 2 notes très courtes

SKILL_ORDER = ("communication", "teamwork", "problem_solving", "motivation")
...
def _recover_interview_payload(text: str) -> dict[str, Any]:
    ...
    recovered = {
        ...
        "skills": _extract_skills(text, score_partial),
        "notes": [],
        "final_report": None,
    }
    return recovered
...
def normalize_llm_payload(
    parsed: dict[str, Any],
    target_phase: Literal["INTRO", "BEHAVIOR", "SOFT", "MOTIVATION", "FINAL"],
    last_index: int,
