...
const translations = {
  fr: {
    ...
    resultsPendingTitle: "Résultats indisponibles pour le moment",
    resultsPendingMessage: "Le candidat doit terminer son entretien avant d'accéder au rapport technique et aux Insights.",
    ...
    reportSubtitle: "Vue technique consolidée du profil et des compétences pour",
    insightsSubtitle: "Vue dédiée aux signaux visuels, vocaux et au stress pour",
    sharePdf: "Partager le PDF",
    sharing: "Partage...",
    downloadPdf: "Télécharger le PDF",
    downloadInsightsPdf: "Télécharger le PDF Insights",
    qrPdf: "QR PDF",
    ...
    closeModal: "Fermer",
    qrLocalHint: "Le lien QR doit être accessible depuis votre téléphone. Si le scan ne s'ouvre pas, utilisez le bouton Ouvrir le PDF.",
    ...
    reportSummary: "Récapitulatif technique",
    reportSummarySubtitle: "Lecture des réponses notées pendant l'entretien technique.",
    status: "Statut",
    dimension: "Question",
    score: "Note",
    keySignal: "Réponse candidat",
    recommendedAction: "Question posée",
    progression: "Progression",
    insights: "Insights",
    visualAndVocal: "Visuel & Vocal",
    insightsSubtitleBlock: "Cette partie regroupe uniquement les observations visuelles, vocales et les indicateurs dérivés.",
    automatedInsights: "Insights automatisés",
    ...
    vocalConfidence: "Confiance moyenne : les observations vocales reposent sur la capture navigateur et des métriques dérivées de la transcription.",
    vocalReading: "Lecture vocale",
    vocalReadingFallback: "Les pauses et silences étaient perceptibles sur plusieurs réponses.",
    pauses: "Pauses",
    hesitations: "Hésitations",
    marked: "marquées",
    pitchAverage: "Pitch moyen",
    steadySignal: "steady",
    hesitationNoteFallback: "Les marqueurs d'hésitation verbale sont restés occasionnels à modérés.",
    average: "moyen",
    finalizedOn: "Session finalisée le",
    total: "Total",
    email: "Email",
    phone: "Telephone",
    linkedin: "LinkedIn",
    ...
    profileInReview: "Profil en évaluation",
    ...
    profileToConsolidate: "Profil à consolider",
    averageAnswerScore: "Note moyenne",
    evaluatedQuestions: "Questions évaluées",
    courseExam: "Examen du cours",
    noAnswerCaptured: "Aucune réponse capturée",
    noQuestionCaptured: "Question indisponible",
    answersGradedLikeExam: "Réponses notées comme un examen",
    basedOnCourseQuestions: "Questions basées sur le cours",
    architecture: "Architecture",
    optimization: "Optimisation",
    debugging: "Debugging",
    llmUnderstanding: "IA / LLM",
    clearExpression: "Conception claire",
    goodCollaboration: "Optimisation maîtrisée",
    analyticalAbility: "Diagnostic technique",
    engagementToStrengthen: "Concepts IA à approfondir",
    technicalReview: "Lecture technique",
    coherentProfile: "Le profil présente un niveau global cohérent et exploitable pour la suite du processus technique.",
    attention: "Attention",
    noMajorAlert: "Aucun signal d'alerte majeur n'a été détecté, mais la lecture doit rester prudente.",
    recommendation: "Recommandation",
    followupRecommendation: "Prévoir un échange complémentaire pour approfondir les points techniques du cours.",
    customEmotionModel: "Modèle émotionnel IA",
    visualEmotionProviders: "Moteur émotionnel visuel",
    speechRate: "Débit",
    volumeLabel: "Volume",
    ...
    factor: "Facteur",
    extractedCvPriority: "Priorité extraite du CV",
    stableReading: "Lecture stable sur cette dimension.",
    followupBehaviorQuestion: "Approfondir avec une question comportementale complémentaire.",
    visualTitle: "Visuels",
    vocalTitle: "Vocaux",
    noVisualSignal: "Aucun signal visuel notable n'a été capturé.",
    noVocalSignal: "Aucun signal vocal notable n'a été capturé.",
    visualSignalsConsolidated: "signaux consolidés",
    vocalIndicators: "indicateurs vocaux",
    indicativeReading: "Lecture indicative",
    observedStress: "Stress observé",
    keyInsights: "Insights clés",
    priorityPoints: "Points prioritaires à retenir",
    ...
    proctoringSubtitle: "Événements détectés pendant l'entretien : onglet, fenêtre, DevTools ou configuration d'écrans.",
    proctoringCount: "alertes enregistrées",
    noProctoringAlerts: "Aucune alerte de surveillance enregistrée.",
    lightMode: "Clair",
    darkMode: "Sombre",
  },
  en: {
...
const dynamicFrToEnMap = new Map<string, string>([
  ...
  ["Le profil présente un niveau global cohérent et exploitable pour la suite du processus technique.", "The profile shows a coherent overall level and is usable for the next technical steps."],
  ["Aucun signal d'alerte majeur n'a été détecté, mais la lecture doit rester prudente.", "No major alert signal was detected, but the reading should remain cautious."],
  ["Prévoir un échange complémentaire pour approfondir les points techniques du cours.", "Plan a follow-up exchange to explore the course's technical points in more depth."],
  ["Expression claire", "Clear expression"],
  ["Bonne collaboration", "Good collaboration"],
  ["Capacité d'analyse", "Analytical ability"],
  ["Engagement à renforcer", "Engagement to strengthen"],
  ["Lecture stable sur cette dimension.", "Stable reading on this dimension."],
  ["Approfondir avec une question comportementale complémentaire.", "Follow up with an additional behavioral question."],
  ["Aucun signal visuel notable n'a été capturé.", "No notable visual signal was captured."],
  ["Aucun signal vocal notable n'a été capturé.", "No notable vocal signal was captured."],
  ["Lecture indicative", "Indicative reading"],
  ["Profil solide", "Strong profile"],
  ["Profil à consolider", "Profile to strengthen"],
...
const dynamicTranslationPairsV2: Array<[string, string]> = [
  ...
  ["La présence visuelle a été stable et bien cadrée tout au long de l'entretien.", "Visual presence remained stable and well framed throughout the interview."],
  ...
  ["Le stress apparent reste limité dans l'ensemble, avec une expression plutôt maîtrisée.", "Observed stress remained limited overall, with fairly controlled expression."],
  ["Pratiquer des exercices de respiration pour soutenir un débit de parole fluide.", "Practice breathing exercises to support a fluid speaking pace."],
  ...
  ["Le débit de parole a paru mesuré, autour de 87.3 mots par minute.", "The speaking pace appeared measured, around 87.3 words per minute."],
  ["Les pauses et silences étaient perceptibles sur plusieurs réponses.", "Pauses and silences were noticeable across several answers."],
  ["Les marqueurs d'hésitation verbale sont restés occasionnels à modérés (0 fillers détectés).", "Verbal hesitation markers remained occasional to moderate (0 fillers detected)."],
...
function translateDynamicTextV2(text: string | undefined, language: Language) {
  ...
  return applyTextReplacementsV2(raw, [
    ...
    ["Thank you for sharing your experience with us.", "Merci d'avoir partagé votre expérience avec nous."],
    ...
    ["Your visual presence remained stable and well framed, showing a good connection with the screen.", "Votre présence visuelle a été stable et bien cadrée, montrant une bonne connexion avec l'écran."],
    ...
    ["Prepare key talking points in advance to guide your speech and reduce unintended pauses.", "Préparez des points clés à l'avance pour guider votre discours et réduire les pauses involontaires."],
    ...
    ["Profile to strengthen", "Profil à consolider"],
    ["Clear expression", "Expression claire"],
    ["Good collaboration", "Bonne collaboration"],
    ["Analytical ability", "Capacité d'analyse"],
    ["Engagement to strengthen", "Engagement à renforcer"],
    ["Stable reading on this dimension.", "Lecture stable sur cette dimension."],
    ["Follow up with an additional behavioral question.", "Approfondir avec une question comportementale complémentaire."],
    ["No notable visual signal was captured.", "Aucun signal visuel notable n'a été capturé."],
    ["No notable vocal signal was captured.", "Aucun signal vocal notable n'a été capturé."],
...
function cleanContactEmail(value: unknown) {
  ...
  if (!match) return raw;
  return match[0].replace(/^(?:linkedin|e-?mail|courriel)[:._-]*/i, "");
}
...
function ReportDashboardPageContent({ forcedView }: { forcedView?: "report" | "insights" } = {}) {
  ...
  const insightsAdvice = payload?.insights_advice || payload?.cached_insights?.insights_advice || null;
  ...
  const liveInsightsPayload: CandidateInsightsPayload | null = payload
    ? {
        ...
        insights_advice: insightsAdvice,
      }
    : null;
  const payloadProctoringEvents = payload?.proctoring_events || [];
  const reportProctoringEvents = finalReport?.proctoring_events || [];
  const proctoringEvents = (payloadProctoringEvents.length ? payloadProctoringEvents : reportProctoringEvents).filter(
  ...
  const contactEmail = cleanContactEmail(payload?.cv_profile?.email);
  const contactPhone = String(payload?.cv_profile?.phone || "").trim();
  const contactLinkedin = String(payload?.cv_profile?.linkedin || "").trim();
  const contactGithub = String(payload?.cv_profile?.github || "").trim();
  const contactItems = [
    {
      label: copy.email,
      value: contactEmail,
    ...
    },
    {
      ...
      href: contactLinkedin ? `https://${contactLinkedin.replace(/^https?:\/\//, "")}` : "",
    },
    {
      label: copy.phone,
      value: contactPhone,
    ...
    },
    {
      label: copy.github,
      value: contactGithub,
      href: contactGithub ? `https://${contactGithub.replace(/^https?:\/\//, "")}` : "",
    },
  ...
  const totalScore = questionRows.length > 0
    ? clamp(averageQuestionScore * 20)
    : Number(finalReport?.score_total || 0);
  ...
  const insightsItems = [
    {
      ...
      text:
        rawDyn(insightsAdvice?.summary?.[0]) ||
    ...
    },
    {
      ...
      text:
        rawDyn(stressContext?.summary) ||
        rawDyn(audioContext?.signals?.[0]) ||
    ...
    },
    {
      ...
      text:
        rawDyn(insightsAdvice?.next_steps?.[0]) ||
  ...
  const stressFactors =
    stressContext?.factors?.map((item) => ({
  ...
  const insightSignalRows = [
    {
      ...
      items:
        (visualContext?.signals || finalReport?.visual_signals || [copy.noVisualSignal]).map((item) => rawDyn(item) || copy.noVisualSignal),
    },
    {
