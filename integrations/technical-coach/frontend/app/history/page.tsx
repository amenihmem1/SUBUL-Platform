...
const historyTranslations = {
  fr: {
    ...
    pinnedSessions: "Sessions épinglées",
    ...
    noRecentCandidate: "Aucun candidat récent",
    ...
    deleteDescription: "sera supprimée de votre historique. Cette action est définitive.",
    deleteSelectedDescription: "conversations seront supprimées de votre historique. Cette action est définitive.",
    delete: "Supprimer",
    select: "Sélectionner",
    ...
    noMatchingConversation: "Aucune conversation correspondante n'a été trouvée.",
    noArchivedConversation: "Aucune conversation archivée pour le moment.",
    noSavedConversation: "Aucune conversation enregistrée pour le moment.",
      ...
      <main className={styles.main}>
        ...
        <section className={styles.kpiGrid}>
          <article className={`${styles.kpiCard} ${styles.historyKpiCard}`}>
            <span className={styles.historyKpiIcon} aria-hidden="true">
              <svg viewBox="0 0 24 24">
                <path d="M14.5 4.5 19.5 9.5" />
                <path d="M15.5 3.5 20.5 8.5" />
                <path d="M8.5 12.5 4 17l3 3 4.5-4.5" />
                <path d="M6.5 14.5 13 8l3 3-6.5 6.5" />
              </svg>
            </span>
            <div className={styles.historyKpiBody}>
              <span>{copy.pinnedSessions}</span>
          ...
          <article className={`${styles.kpiCard} ${styles.historyKpiCard}`}>
            ...
            <div className={styles.historyKpiBody}>
              <span>{copy.archivedSessions}</span>
