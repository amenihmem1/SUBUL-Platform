...
const helpTranslations = {
  fr: {
    ...
    title: "Centre d'aide",
    subtitle:
      "Retrouvez ici le parcours idéal pour lancer un entretien technique basé sur les cours, ouvrir le rapport noté et exploiter l'historique candidat.",
    quickStart: "Démarrage rapide",
    quickStartHint: "Les 4 étapes les plus utiles pour utiliser l'application.",
    quickStartLabel: "Étape",
    uploadCv: "Cours depuis Subul",
    uploadCvHint: "Le cours associé au candidat dans Subul est utilisé pour guider les questions techniques.",
    ...
    openReportsHint: "Le rapport technique devient accessible une fois la session finalisée.",
    reviewHistory: "Consulter l'historique",
    reviewHistoryHint: "Retrouvez les entretiens précédents, les scores et les conversations épinglées.",
    workflowTitle: "Workflow recommandé",
    workflowSubtitle: "Un chemin simple pour ne rien oublier pendant une session.",
    workflowOneTitle: "1. Récupérer le cours Subul",
    workflowOneText: "L'agent utilise le cours associé au candidat dans Subul pour préparer les questions de l'entretien.",
    workflowTwoTitle: "2. Mener l'échange",
    workflowTwoText: "En mode micro, ouvrez le micro pour parler puis refermez-le quand vous avez terminé afin de lancer la transcription.",
    workflowThreeTitle: "3. Finaliser la session",
    workflowThreeText: "Terminez l'entretien depuis le panneau de contrôle afin de générer le rapport complet.",
    workflowFourTitle: "4. Explorer les résultats",
    workflowFourText: "Ouvrez Technique et Historique pour relire les questions, les réponses et les notes obtenues.",
    workflowCardTitle: "Parcours recommandé",
    navigationTitle: "Que contient chaque page ?",
    navigationSubtitle: "Résumé rapide des sections disponibles dans le menu.",
    ...
    navHrText: "Rapport technique avec score global, notes par question et récapitulatif d'examen.",
    navHistoryTitle: "Historique",
    navHistoryText: "Liste des sessions, recherche, archivage, épinglage et reprise rapide.",
    tipsTitle: "Bonnes pratiques",
    tipsSubtitle: "Quelques repères pour des sessions plus fluides.",
    unlockTitle: "Ce qui débloque les rapports",
    unlockSubtitle: "Le rapport technique s'active lorsque le cycle de session est complet.",
    unlockOneTitle: "Cours Subul détecté",
    unlockOneText: "Le cours associé au candidat est disponible pour guider les questions de l'entretien.",
    unlockTwoTitle: "Entretien mené",
    unlockTwoText: "Les questions et les réponses du candidat alimentent la notation.",
    unlockThreeTitle: "Session finalisée",
    unlockThreeText: "Le rapport complet devient disponible avec le score global et les notes par question.",
    tipOne: "Vérifier que le candidat est bien associé au bon cours dans Subul garantit des questions liées au bon support.",
    tipTwo: "Finaliser proprement la session est nécessaire pour débloquer le rapport technique.",
    tipThree: "L'historique est utile pour retrouver les sessions actives, les rapports complétés et les favoris.",
    tipFour: "En mode micro, cliquez une première fois pour enregistrer votre réponse puis une seconde fois pour arrêter et envoyer la transcription.",
    supportTitle: "Support rapide",
    supportSubtitle: "Posez une question ou utilisez les raccourcis pour résoudre les problèmes fréquents.",
    supportWelcome: "Bonjour, je peux vous aider avec le cours, l'entretien, les questions, le rapport technique et la notation.",
    supportPlaceholder: "Exemple : comment le cours est-il utilisé ?",
    supportSend: "Envoyer",
    supportFallback: "Je n'ai pas trouvé de réponse exacte. Vérifiez que le candidat est associé au bon cours dans Subul, lancez l'entretien, puis finalisez la session pour ouvrir le rapport technique.",
    faqCourseQuestion: "Comment le cours est-il utilisé ?",
    faqCourseAnswer: "Le cours vient de Subul selon le parcours ou le cours associé au candidat. L'agent pose ensuite des questions basées sur ce contenu.",
    faqBackendQuestion: "Comment démarrer l'entretien ?",
    faqBackendAnswer: "Ouvrez la page Interview, préparez le cours, puis envoyez le premier message ou utilisez le micro pour commencer.",
    faqFrontendQuestion: "Comment terminer l'entretien ?",
    faqFrontendAnswer: "Quand les questions sont terminées, finalisez la session depuis l'interface. Le rapport technique sera alors disponible.",
    faqQuestionQuestion: "Pourquoi les questions ne suivent pas le cours ?",
    faqQuestionAnswer: "Vérifiez que le candidat est associé au bon cours dans Subul et que le contenu du cours est lisible par l'application.",
    faqReportQuestion: "Pourquoi le rapport n'apparaît pas ?",
    faqReportAnswer: "Le rapport s'affiche après finalisation de la session. Terminez l'entretien, puis ouvrez la page Technique depuis le menu ou l'historique.",
    faqScoreQuestion: "Comment fonctionne la note ?",
    faqScoreAnswer: "Chaque réponse est notée sur 5 comme dans un examen. Le score global sur 100 est calculé à partir des notes obtenues.",
  },
  en: {
    mainMenu: "Main menu",
