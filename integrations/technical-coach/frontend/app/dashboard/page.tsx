...
const copy = {
  fr: {
    ...
    subtitle: "Vue globale des entretiens techniques, des scores, de l'activité et des signaux vocaux.",
    ...
    reviewNeeded: "À surveiller",
    dashboardInsight: "Ces indicateurs donnent une lecture rapide de la qualité des entretiens finalisés et des axes à consolider.",
    ...
    voiceSamples: "échantillons",
    speechRate: "Débit",
    vocalEnergy: "Énergie",
    silence: "Silence",
    pitch: "Pitch",
    pauses: "Pauses",
    voiceNote: "Moyennes consolidées à partir des captures vocales des entretiens finalisés.",
    noVoiceData: "Aucune métrique vocale exploitable pour cette période.",
    activity: "Activité des entretiens",
    scoredActivity: "Entretiens notés",
    lastDays: "Période",
    range7: "7 jours",
    range14: "14 jours",
    range30: "30 jours",
...
function buildProctoringAlertDistribution(events: Array<{ reason?: string }>, language: Language): ProctoringDistItem[] {
  ...
  const labelFor = (key: ProctoringDistKey): string => {
    const labels: Record<ProctoringDistKey, { fr: string; en: string }> = {
      ...
      window_resize: { fr: "Réduction de fenêtre", en: "Window resize" },
      devtools: { fr: "DevTools", en: "DevTools" },
      multiple_screens: { fr: "Plusieurs écrans", en: "Multiple screens" },
                    ...
                    <div className={styles.donutLegend}>
                      {emotionItems.map((item) => (
                        <div
                          ...
                          key={item.key}
                        >
                          <span className={styles.emotionLegendIcon} style={{ color: emotionColors[item.key] }} aria-hidden="true">
