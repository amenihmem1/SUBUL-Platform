...
function LiveEmotionIcon({ emotion, className = "" }: { emotion: LiveEmotionLabel | ""; className?: string }) {
  const iconClassName = `candidate-emotion-live-icon is-${emotion || "idle"} ${className}`.trim();
    ...
    return (
      <span className={iconClassName} aria-hidden="true">
        <svg viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="8.5" />
          <path d="M8.5 10h.01M15.5 10h.01" />
          <path d="M8.4 16c1.9-1.9 5.3-1.9 7.2 0" />
        </svg>
      </span>
    );
  }
  ...
  if (emotion === "angry") {
    return (
      <span className={iconClassName} aria-hidden="true">
        <svg viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="8.5" />
          <path d="m7.8 8.7 2.2.8M16.2 8.7l-2.2.8" />
          <path d="M8.7 16h6.6" />
        </svg>
      </span>
    );
    ...
    return (
      <span className={iconClassName} aria-hidden="true">
        <svg viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="8.5" />
          <path d="M8.5 10h.01M15.5 10h.01" />
          <ellipse cx="12" cy="15" rx="2" ry="2.6" />
        </svg>
      </span>
    );
  }
        ...
        <div className="candidate-analysis" aria-live={liveVisionEnabled ? "polite" : undefined}>
          ...
          <div className={`candidate-emotion-live is-${displayedLiveEmotion.dominantEmotion || "idle"}`}>
            <div className="candidate-emotion-live-header">
              <div className="candidate-emotion-live-heading">
                <LiveEmotionIcon emotion={displayedLiveEmotion.dominantEmotion} className="is-featured" />
                ...
                return (
                  <div key={label} className="candidate-emotion-live-bar">
                    <span className="candidate-emotion-live-bar-label">
                      <LiveEmotionIcon emotion={label} />
                      {formatLiveEmotionLabel(label)}
                    </span>
