...
function SessionRow({
  ...
  onMenuToggle: (rowId: string | null) => void;
          ...
          <>
            <button
              ...
              onClick={(event) => {
                ...
                onMenuToggle(menuOpen ? null : menuRowId);
              }}
            >
                  ...
                  <section key={section.key} className="history-chat-section">
                    ...
                    <div className="history-chat-list">
                      {section.sessions.map((session, sessionIndex) => {
                        const rowId = `${section.key}-${session.session_id}-${sessionIndex}`;
                        return (
                        <SessionRow
                          key={rowId}
                          entry={session}
                          ...
                          menuOpen={menuRowId === rowId}
                          menuRowId={rowId}
                          copy={copy}
                          onOpen={onOpenSession}
                          onToggleSelected={toggleSessionSelected}
                          onMenuToggle={setMenuRowId}
