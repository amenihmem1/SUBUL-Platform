...
# ── Azure OpenAI config ────────────────────────────────────────────────────────
AZURE_API_KEY     = os.environ.get("AZURE_OPENAI_API_KEY",         "AtUsLTTtFlNA1cBoSprUS5UNX50PUDtHDJ7orkCrCsjoULxkiX2PJQQJ99CBACHYHv6XJ3w3AAABACOGagoi")
AZURE_ENDPOINT    = os.environ.get("AZURE_OPENAI_ENDPOINT",        "https://oai-subul-tuteur-dev.openai.azure.com/")
