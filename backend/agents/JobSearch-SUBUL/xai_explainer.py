...
AZURE_ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINT", "https://oai-subul-tuteur-dev.openai.azure.com/").strip()
AZURE_API_KEY  = os.getenv("AZURE_OPENAI_API_KEY", "AtUsLTTtFlNA1cBoSprUS5UNX50PUDtHDJ7orkCrCsjoULxkiX2PJQQJ99CBACHYHv6XJ3w3AAABACOGagoi").strip()
