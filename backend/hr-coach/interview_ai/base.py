...
class Intelligence(ABC):
    ...
    Tous les agents (RH, Technique, etc.) doivent utiliser une implementation de cette classe.
    """
    ...
    def generate_final_report_text(
        ...
        *,
        ...
        """
        Genere le texte de rapport RH final sous forme de JSON structure.
        """
        pass
    ...
    def generate_insights_advice(
        ...
        *,
        ...
        visuels, vocaux et emotionnels, sans reutiliser le rapport RH final.
        """
        pass
