...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    ...
    const defaultHrCoach = dev
      ? 'http://127.0.0.1:8083'
      : 'https://hr-coach-frontend.bravesand-e5d986f3.francecentral.azurecontainerapps.io';
    const defaultTechnicalCoach = dev
      ? 'http://127.0.0.1:8082'
    ...
    return [
      ...
      { source: '/hr-coach-app/api/rh/session/:sessionId/report/view', destination: `${hrCoach}/hr-coach-app/api/rh/session/:sessionId/report/view` },
      { source: '/hr-coach-app/api/rh/session/:sessionId/insights-report', destination: `${hrCoach}/hr-coach-app/api/rh/session/:sessionId/insights-report` },
      ...
      { source: '/:locale(en|fr)/hr-coach-app/api/rh/session/:sessionId/report/view', destination: `${hrCoach}/hr-coach-app/api/rh/session/:sessionId/report/view` },
      { source: '/:locale(en|fr)/hr-coach-app/api/rh/session/:sessionId/insights-report', destination: `${hrCoach}/hr-coach-app/api/rh/session/:sessionId/insights-report` },
      ...
      { source: '/technical-coach-app/api/tech/session/:sessionId', destination: `${technicalCoach}/technical-coach-app/api/tech/session/:sessionId` },
      { source: '/technical-coach-app/api/tech/session/:sessionId/:path*', destination: `${technicalCoach}/technical-coach-app/api/tech/session/:sessionId/:path*` },
      { source: '/technical-coach-app/api/tech/sessions', destination: `${technicalCoach}/technical-coach-app/api/tech/sessions` },
      { source: '/technical-coach-app/api/tech/sessions/:path*', destination: `${technicalCoach}/technical-coach-app/api/tech/sessions/:path*` },
      { source: '/:locale(en|fr)/technical-coach-app/api/tech/session/:sessionId', destination: `${technicalCoach}/technical-coach-app/api/tech/session/:sessionId` },
      { source: '/:locale(en|fr)/technical-coach-app/api/tech/session/:sessionId/:path*', destination: `${technicalCoach}/technical-coach-app/api/tech/session/:sessionId/:path*` },
      { source: '/:locale(en|fr)/technical-coach-app/api/tech/sessions', destination: `${technicalCoach}/technical-coach-app/api/tech/sessions` },
      { source: '/:locale(en|fr)/technical-coach-app/api/tech/sessions/:path*', destination: `${technicalCoach}/technical-coach-app/api/tech/sessions/:path*` },
      { source: '/technical-coach-app', destination: `${technicalCoach}/technical-coach-app` },
      { source: '/technical-coach-app/:path*', destination: `${technicalCoach}/technical-coach-app/:path*` },
      { source: '/:locale(en|fr)/technical-coach-app', destination: `${technicalCoach}/technical-coach-app` },
      { source: '/:locale(en|fr)/technical-coach-app/:path*', destination: `${technicalCoach}/technical-coach-app/:path*` },
