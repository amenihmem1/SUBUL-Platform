...
const OPTIONS: Array<{ value: InputMode; label: string; description: string }> = [
  { value: "mixed", label: "Mixte", description: "Texte et micro disponibles." },
  { value: "voice", label: "Micro", description: "Réponses uniquement au micro." },
  { value: "text", label: "Texte", description: "Réponses uniquement au clavier." },
];
