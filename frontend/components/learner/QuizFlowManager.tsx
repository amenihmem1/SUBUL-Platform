        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: '#7A6E99' }}>
              <Clock size={11} /> {cert.duree_preparation_semaines} sem.
            </span>
            <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: '#7A6E99' }}>
              <BookOpen size={11} /> {cert.heures_etude}h d'étude
            </span>
    ...
    <div style={{ marginBottom: 28 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Clock size={11} /> {phase.duration_weeks} sem.
        </div>
      </div>
    ...
    <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ fontSize: 11, color: '#B0A8C8', marginTop: 1 }}>
                🔷 Azure · 🟠 AWS · {roadmap.total_certifications} certifications · {roadmap.total_estimated_weeks} semaines
              </div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 16, marginTop: 14, flexWrap: 'wrap' }}>
            {[
              ...
              { icon: Clock, label: `${roadmap.total_estimated_weeks} semaines` },
      ...
      <div style={{
        ...
        <p style={{ flex: 1, fontSize: 12, color: '#7A6E99', margin: 0 }}>
          Roadmap sauvegardé. Les certifications sont ordonnées du niveau le plus bas au plus élevé.
        </p>
        <button
          onClick={onClose}
          style={{
              ...
              <div style={{ padding: '48px 32px', display: 'flex', flexDirection: 'column',
                ...
                <div>
                  <div style={{ fontSize: 18, fontWeight: 800, color: '#1A1230', marginBottom: 6 }}>
                    Génération de votre roadmap…
                  </div>
                  <div style={{ fontSize: 13, color: '#B0A8C8', lineHeight: 1.6 }}>
                    L'IA sélectionne les meilleures certifications<br />
                    Azure et AWS pour votre profil
                  </div>
                </div>
                ...
                <div style={{ width: '100%', maxWidth: 360 }}>
                  {[
                    { label: 'Analyse du profil et du niveau', done: true },
                    { label: 'Recherche certifications Azure & AWS', done: !!roadmapText },
                    { label: 'Ordonnancement par niveau', done: !!roadmapText },
                    { label: 'Génération du roadmap personnalisé', done: false },
                  ].map(({ label, done }, i) => (
                    <div key={i} style={{
            ...
            {phase === 'done' && !parsedRoadmap && (
              <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div style={{ padding: '12px 20px', borderTop: '1px solid rgba(123,47,190,.08)',
                  ...
                  <CheckCircle size={15} color="#10B981" />
                  <span style={{ flex: 1, fontSize: 12, color: '#7A6E99' }}>Roadmap généré avec succès.</span>
